...
SECRET_KEY = 'django-insecure-9m(9%i51y*%a7lry)$3kqgm2+fw6o9v*75n^$f09a&sbv2cto%'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': (
        ...
        'rest_framework.renderers.BrowsableAPIRenderer',  # Pour le rendu dans le navigateur
    ),
}

WSGI_APPLICATION = 'projettt.wsgi.application'
